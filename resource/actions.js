const actionlist = [
    ...
    // Alter Actions - Corrupt
    {
        ...
        dice: "Free/Bonus Action",
        use: ["main"],
        roll: "?r exchange <span class='masteryreplace'>MR</span> # Character Name · <span class='thrcode'>Code</span>",
        masteries: ["corrupt"],
        category: "alter",
        pair: "Q1",
        type: "Alter - Corrupt",
    },
    {
        ...
        dice: "Free Action",
        use: ["main"],
        roll: "?r wagerfuture <span class='masteryreplace'>MR</span> # Character Name · <span class='thrcode'>Code</span> · Bank (<span class='target'>Bank</span>)",
        masteries: ["corrupt"],
        category: "alter",
        pair: "Q1",
        type: "Alter - Corrupt",
