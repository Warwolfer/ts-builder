const actionlistV2 = [
  ...
  },
  {
    ...
    description:
      "<p>You are Vulnerable.</p><p>Success: Whenever you roll a 30 or higher, your attack gains 30 (D), 40 (B), 50 (S) extra damage and you negate the Vulnerability status from this attack.</p><p>Melee: If you are adjacent to or on the space as your attack target, gain 30 extra damage.</p>",
  ...
  },
  {
    ...
    image: "https://terrarp.com/db/action/dba3.png",
    description:
      "<p>(D) Free Action. Deals an instance of damage to an enemy adjacent to you: 5 (D), 10 (C), 15 (B), 20 (A), 25 (S)</p><p>(D) Bonus Action: Ultra Torment. Double your Torment damage.</p><p>(D) Bonus Action: Radial Torment. Apply Torment damage to all enemies adjacent to you.</p>",
  ...
  },
  {
    ...
    description:
      "<p>Success: On a roll of 30 or higher, gain 20 (D) 25 (C) 30 (B) 35 (A) 40 (S) extra damage, otherwise +10.</p>",
    dice: "1d100 + [*] + MR + WR + other bonuses",
    use: ["main"],
  ...
  },
  {
    ...
    description:
      "<p>You are Vulnerable.</p><p>Free Action: Convert other bonuses into more dice that may trigger crits. +1d100 for each 40 you spend. Leftover values are added as a modifier.</p><p>(E, D, C) Main Action. Roll 1d200 + 1d100 + MR + WR + other bonuses.</p><p>(B, A, S) Main Action. Roll 1d200 + 1d100 + 1d100 + MR + WR + other bonuses.</p>",
  ...
  },
  {
    ...
    image: "https://terrarp.com/db/action/heal.png",
    description:
      "<p>Explosion: Whenever you roll a 15 or higher, roll an extra d20 (30% chance).</p><p>Cleanse: Whenever you heal a target cleanse 2 (D), 3 (B), 4 (S) after healing. Gain 5 HP to your heal per unused cleanse charge.</p>",
  ...
  // Alter Actions - Corrupt
  {
    ...
    description:
      "<p>Free Action: You may reduce 1d20 Save in the next damage phase and gain the same amount as extra modifier to attack, buff, or heal. (Note: the DM has the option to change Save to HP depending on the encounter).</p><p>(B) Upgrade: 1d20 → 2d20</p><p>(S) Upgrade: 2d20 → 3d20</p><p>Bonus Action: Defile. Roll Exchange again with Advantage.</p>",
    dice: "Free/Bonus Action",
    use: ["main"],
  ...
  },
  {
    ...
    description:
      "<p>(D) Passive. Gain extra movement. 2 (D), 3 (B), 4 (S)</p><p>(D) Passive. Passive. Gain a +2 bonus to Fortitude and Will, and +5 to Reflex Save per unspent movement in the next damage phase.</p>",
    dice: "Passive",
    use: ["passive"],
    roll: "?r acceleration # Character Name · <span class='thrcode'>Code</span>",
    masteries: ["dynamism"],
    category: "alter",
    pair: "O1",
    type: "Alter - Dynamism",
  ...
  // Alter Actions - Hyper Sense
  {
    ...
    description:
      "<p>(D) Bonus Action: The next 2 attacks to your marked enemy gains a +10 (D) +15 (C) +20 (B) +25 (A) +30 (S) damage modifier. You cannot recast Death Mark until all charges are expended, if there are multiple Hyper Sense users, Marks may stack.</p><p>(A) Upgrade: 2 → 3 attacks.</p>",
    dice: "Bonus Action",
    use: ["bonus"],
  ...
  },
  {
    ...
    description:
      "<p>(D) Free Action: Grant yourself or an ally within range an instance of 15 (D), 20 (B), 25 (S) Break damage and imbue the attack with one of your masteries this cycle.</p><p>(A) Bonus Action: Ultra Insight. Double Hyper Insight's damage.</p>",
    dice: "Free/Bonus Action",
    use: ["bonus"],
  ...
  },
  {
    ...
    description:
      "<p>(D) Passive: Gain 5 (D), 10 (B), 15 (S) to a save roll in the next damage phase.</p><p>(A) Bonus Action: Ultra Instinct. Double your Hyper Instinct bonus.</p>",
    dice: "Passive/Bonus Action",
    use: ["passive", "bonus"],
